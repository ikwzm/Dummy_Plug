...
set project_name            "axi4_test_1_5"
...
lappend work_src_list       {../../../src/test/vhdl/axi4/axi4_test_1_5.vhd}
add_files -fileset sim_1 -norecurse $work_src_list

set scenario_file [file join $project_directory ".." ".." ".." "src" "test" "scenarios" "axi4" "axi4_test_1_5.snr" ]
