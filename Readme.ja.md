...
*Dummy Plug* は VHDL だけで書かれたシンプルなバス機能モデルのライブラリです.  

AXI4 および AXI4-Stream のマスターモデルとスレーブモデルに対応しています.  
...
```YAML
--- # AXI DUMMU-PLUG SAMPLE SCENARIO 1    # シナリオの章の開始.これで全てのダミープラグが同期.
- - MASTER                                # AXI マスター用ダミープラグの名前. 
